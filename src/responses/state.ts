...
function schedulePersist(): void {
  ...
  // Resolve the target path now: tests may swap DSH_CHATGPT_FREE_HOME before the
...
export function flushResponseState(): void {
  if (!persistTimer) return;
  // Use the path captured when the write was scheduled; DSH_CHATGPT_FREE_HOME may have moved.
